...
#define LINE_TOKEN  "cwKttuzxkDI7e4xZo7lEIsdnP0UlbHOz" //สร้างตัวแปรสำหรับเก็บค่า Token
//
...
char ssid[] = "iRAP-AP"; // สร้างตัวแปรสำหรับเก็บชื่อ WiFi
char pass[] = "irapiluvu"; // สร้างตัวแปรสำหรับเก็บ รหัสผ่าน WiFi
